    ...
    <div class="row">
      <div class="col-lg-4">
        <a  href="" class="functions" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          <img src="../../Imagenes/RegistrarPedido.png"   width="160" height="160" role="img" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"></text></svg>
        </a> 
              ...
              <div class="modal-body p-5 pt-0">
                <form class="">
                  ...
                  <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="./RegistrarPedido/registrarPedido.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?>">Continuar</button></a>
      ...
      <div class="col-lg-4">
        <a href="https://example.com/">
          <img src="../../Imagenes/arqueo.png"  width="160" height="160" role="img" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"></text></svg>
        </a> 
