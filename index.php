...
<style>
  ...
  <body>
    <div class="container w-75 mt-5 rounded-lg shadow-lg">
		<div class="row aling-items-stretch">
			<div class="col-md bg d-none d-lg-block col-md-5 col-lg-5 col-xl-6 rounded-lg">
			</div>
			<div class="col-sm bg-white p-5 rounded-end">
