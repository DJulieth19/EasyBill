            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                ...
                <a href="../Administrador/AdministrarUsuarios/Usuarios.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?>">
                  <img src="https://res.cloudinary.com/dongfmggz/image/upload/v1658246974/samples/food/dessert.jpg" href= class="bd-placeholder-img" width="160" height="160" role="img" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"></text></svg>
                </a> 
                <h7 class="fw-normal">Precio</h2>
