    ...
    <div class="container w-25 bg-purple my-5 rounded-lg shadow-lg">
		<div class="row aling-items-stretch">
			<div class="col bg-white p-5 rounded-end">
				...
				<form action="nombre.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?>" method="POST">
					<div class="mb-1">
					...
					<div class="mb-1">
						<label for="username" class="form-label">Ingrese su nueva nombre de usuario</label>
						<input type="text" class="form-control" name="nuevonombre" placeholder="" required>	
					</div>
					<div class="d-grid py-2">
						<div class="row">
							<div class="col d-grid">
								<button type="button" onclick="location.href='../index.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?>" class="btn btn-primary">Volver</button>
							</div>
							<div class="col d-grid">
