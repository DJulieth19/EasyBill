                ...
                <div class="table-responsive table-striped table-bordered">
                    ...
                    <?php
                        ...
                        if($TipoConsulta == "Hoy"){
                            ...
                            $query = "SELECT p.nombreProducto,sum(a.cantidad) AS cantidad,sum(a.total_producto) AS total from Productos p, asigna a, Venta v where p.codProducto=a.codProducto and v.id_venta=a.id_venta and v.Fecha BETWEEN '2022-02-07 00:00:00' AND '$finDia' GROUP BY p.nombreProducto";
                        }
