...
$queryUsuarios = "SELECT id_usuario from usuarios WHERE nombre_usuario='$Nombre' AND tipo_usuario='$tipo';";
...
$usuario = $nuevonombre;
header("location: ../index.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?");
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container w-25 bg-purple my-5 rounded-lg shadow-lg">
        <div class="row aling-items-stretch">
            <div class="col bg-white p-5 rounded-end">
                ...
                <h2 class="fw-bold text-center py-2">Cambio de nombre</h2>
                <div class="mb-1">
                    <label for="email" class="form-label">Su nombre ha sido modificada correctamente</label>
                </div>
