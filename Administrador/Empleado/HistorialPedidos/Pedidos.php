                ...
                <div class="table-responsive table-striped table-bordered">
                    <table class="table table-hover">
                        ...
                        if($TipoConsulta == "Hoy"){
                            ...
                            $query = "SELECT u.nombre_usuario,v.nombreCliente,v.valorVenta,v.fecha from usuarios u, ventas v where v.id_usuario=u.id_usuario and u.nombre_usuario='$usuario' and v.fecha BETWEEN '$inicioDia' AND '$finDia'";
                        }
                        if($TipoConsulta == "Semana"){
                            $inicio = date("Y-m-d");
                            $SemanaAntes = strtotime('-7 day', strtotime($inicio));
                            $SemanaAntes = date('Y-m-d', $SemanaAntes);         
                            $query = "SELECT u.nombre_usuario,v.nombreCliente,v.valorVenta,v.fecha from usuarios u, ventas v where v.id_usuario=u.id_usuario and u.nombre_usuario='$usuario' and v.fecha BETWEEN '$SemanaAntes' AND '$inicio'";
                        }
                        if($TipoConsulta == "Mes"){
                            $inicio = date("Y-m-01");
                            $fin = date("Y-m-t");
                            $query = "SELECT u.nombre_usuario,v.nombreCliente,v.valorVenta,v.fecha from usuarios u, ventas v where v.id_usuario=u.id_usuario and u.nombre_usuario='$usuario' and v.fecha BETWEEN '$inicio' AND '$fin'";
                        }
