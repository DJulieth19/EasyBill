...
<main>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <a href="https://example.com/">
          <img src="../Imagenes/actividad.png" href= class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"></text></svg>
        </a> 
