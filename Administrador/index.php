              ...
              <form class="d-flex" role="search">
                <div class="NombreUser">
                  ...
                  <a type="button" class="nav-bar-icons">
                            <div class="dropdown">
                              <a class="btn btn-dark dropdown-toggle mt-1" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
...
<main>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <a href="../Administrador/ConsultaVentas/Ventas.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?>&consulta=Hoy">
      ...
      <div class="col-lg-4">
        <a href="../Administrador/HistorialPedidos/Pedidos.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?>&consulta=Hoy">
      ...
      <div class="col-lg-4">
        <a href="../Administrador/AdministrarMenu/menu.php?nombre=<?php echo $usuario?>&tipoUsuario=<?php echo $tipo?>">
